            ...
            <div class="white-box">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form class="" method="POST" id="role_form" action="{{route('admin.update_role_permission')}}" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-6 ">
                                                        ...
                                                        @foreach ($permission as $key => $value)
                                                                <div class="col-md-4">
                                                                    <div class="checkbox checkbox-success">
                                                                        <input id="{{$key}}" type="checkbox" name="permission[]" value="{{$value['id']}}" {{ $rolePermissions->contains($value['id']) ? "checked" : "" }}>
