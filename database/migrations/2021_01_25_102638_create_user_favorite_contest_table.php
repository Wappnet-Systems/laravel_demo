...
class CreateUserFavoriteContestTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('user_favorite_contest', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('user_favorite_contest');
    }
}
