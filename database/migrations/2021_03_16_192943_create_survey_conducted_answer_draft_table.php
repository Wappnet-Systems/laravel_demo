...
class CreateSurveyConductedAnswerDraftTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('survey_conducted_answer_draft', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('survey_conducted_answer_draft');
    }
}
