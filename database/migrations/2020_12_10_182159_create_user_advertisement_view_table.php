...
class CreateUserAdvertisementViewTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('user_advertisement_view', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('user_advertisement_view');
    }
}
